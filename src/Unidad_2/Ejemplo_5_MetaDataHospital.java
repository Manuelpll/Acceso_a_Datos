...
public class Ejemplo_5_MetaDataHospital {
    public static void main(String[] args) {
        try {
            ...
            resul = dbmd.getTables(null, "Mparr", null, null);
            while (resul.next()) {
            ...
            columnas = dbmd.getColumns(null, "hospital", "emp", null);
            while (columnas.next()) {
            ...
            ResultSet pk = dbmd.getPrimaryKeys(null, "hospital", "emp");
