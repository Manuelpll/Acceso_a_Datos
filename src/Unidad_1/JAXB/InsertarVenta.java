...
public class InsertarVenta {
        ...
        public static void insertarVenta(int numVenta, String nomCli, int uni, String fecha) {
            ...
            try {
                ...
                JAXBElement<VentasType> jaxbElement = (JAXBElement<VentasType>) unmarshaller.unmarshal(new File("C:\\Users\\aludam2\\IdeaProjects\\Acceso_a_Datos\\Archivos\\ventasarticulos.xml"));
